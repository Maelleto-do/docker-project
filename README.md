Ce projet est un petit entraînement sur Docker via la création de deux images contenant des versions de Python différentes et un environnement de développement différent (Qiskit et Pennylane).
